        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-6 mx-auto">
                    <form action="{{ url('football/Player/Statistics/Create') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="assist" id="assist" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label for="yellow_card" class="form-label">Yellow Cards</label>
                            <input type="number" name="yellow_card" id="yellow_card" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label for="red_card" class="form-label">Red Cards</label>
                            <input type="number" name="red_card" id="red_card" class="form-control" required>
                        </div>
