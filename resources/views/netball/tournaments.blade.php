                ...
                <table id="example" class="table table-striped data-table" style="width: 100%">
                    ...
                    <tbody>
                        ...
                        <td class="text-center">
                            <a href="{{url("netball/Tournaments/Update?tournament_id=$tournament->id")}}" class="btn btn-primary">edit</a>
                            <a href="{{url("netball/Tournaments/Delete?tournament_id=$tournament->id")}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this Tournament?')">delete</a>                        </td>
                        </tr>
                        @empty 
                        <tr>
